  ...
  const formatAnalysis = (text) => {
    return text.split('\n').map((line, index) => {
      if (line.includes('**') && line.includes('**')) {
        ...
        return (
          <div key={index} className="font-bold text-lg mt-4 mb-2 text-gray-800">
            {boldText}
          </div>
        );
      }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Upload your health report to get AI-powered insights about potential future health risks and personalized recommendations
          </p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div className="text-center">
                  <div className="bg-white border-2 border-gray-200 rounded-xl p-4 inline-block mb-4 shadow-sm">
                    {qrCodeUrl ? (
                      <img 
                        src={qrCodeUrl} 
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-3">Shareable Link</h4>
            ...
            <div className="bg-amber-50 border-l-4 border-amber-400 rounded-xl p-6">
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-bold text-amber-900 text-lg mb-2">Important Medical Disclaimer</h4>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                onClick={resetForm}
                className="flex-1 py-4 px-6 border-2 border-blue-600 text-blue-600 rounded-xl font-semibold
              ...
              <button
                ...
                className="flex-1 py-4 px-6 bg-gradient-to-r from-gray-600 to-gray-700 text-white rounded-xl font-semibold
                         hover:from-gray-700 hover:to-gray-800 transition-all duration-200 transform hover:scale-105"
              >
                Print Analysis
              </button>
            </div>
